...
t.login.captcha = "验证码";
t.login.demo = "在线演示";
t.login.copyright = "升鲜宝开源";

t.home = {};
t.home.desc = {};
t.home.desc.title = "项目介绍";
t.home.desc.list = [
  "升鲜宝微服务平台，是基于Spring Cloud打造的微服务平台，为企业提供一站式微服务解决方案",
...
t.oss.aliyunDomainTips = "阿里云绑定的域名，如：http://cdn.loveinway.com";
...
t.oss.localDomainTips = "绑定的域名，如：http://cdn.loveinway.com";
t.oss.fastdfsDomain = "域名";
t.oss.fastdfsDomainTips = "绑定的域名，如：http://cdn.loveinway.com";
